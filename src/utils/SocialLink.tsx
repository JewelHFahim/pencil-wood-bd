  ...
  return (
    <div className="flex space-x-6">
      {socialLinks?.data
        ...
        .map((item) => { 
          const IconComponent = Icons[item.icon as keyof typeof Icons] || FaIcons[item.icon as keyof typeof FaIcons];

          return (
            <Link key={item?.id} to="" className=" mt-8 flex items-center gap-1">
