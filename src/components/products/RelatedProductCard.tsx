    ...
    <div className="ProductCard-Wrapper">
      <Link to={`/products/${product?.id}`} className="">
        ...
        <button
          ...
          className="w-full h-8 rounded-b-sm bg-primary font-medium text-xs md:text-sm text-gray-100 uppercase"
        >
          Add To Cart
        </button>

        <div className="mt-1">
          <h2 className="text-sm md:text-base font-medium">{product?.name?.slice(0, 20)}</h2>
